...
sSequence = "CKKOHNSBPCPCHVNKHFFK"
...
part2Steps :: Int -> String -> Map String String -> String
part2Steps 40 stringy mapp = stringy
part2Steps x stringy mapp  = part2Steps (x+1) (replace stringy mapp) mapp

part1map :: String -> Map Char Int -> Map Char Int
part1map [x] mapp = case Map.lookup x mapp of
    Nothing -> Map.insert x 1 mapp
    Just r -> Map.insert x (r+1) mapp
part1map (x:xs) mapp = part1map xs (part1map [x] mapp)

-- part1BigAndSmall :: Map Char Int -> Int -> Int -> Int
-- part1BigAndSmall mapp big small 